			...
			for epoch in range(epochs):
					...
					while True:
						...
						try:
							...
							print "here"
							_, train_loss, err, summ, probs = sess.run([self.model.train_ops, self.model.cost, self.model.classification_error, summary_op, self.model.softmax_layer_nonlin.gammas_lab], feed_dict = feed_dict)			
							print "gogo", batch_no, summ
