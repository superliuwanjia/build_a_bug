...
class Model():
	...
	def Compile(self):
		...
		with tf.name_scope("ffl"):
			...
			self.softmax_layer_nonlin = SoftmaxNonlinearity(input_lab=softmax_input_lab, input_unl=None,input_clean=None)
	...
	def BuildCost(self):
		...
		with tf.name_scope("accuracy"):
			...
			tf.summary.scalar("train_accuracy", self.classification_error)
